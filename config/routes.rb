ActionController::Routing::Routes.draw do |map|
  ...
  # dashboard_url is / , not /dashboard ===> previous
  #map.dashboard '', :controller => 'users', :action => 'user_dashboard', :conditions => {:method => :get}
  #map.root :dashboard

  #/dashboard_url is now for /dashboard
  map.dashboard 'dashboard_home', :controller => 'users', :action => 'user_dashboard', :conditions => {:method => :get}
